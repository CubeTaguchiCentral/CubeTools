 ...
 * @author Wiz
 */
public class C2FMusicFileConverter {
    ...
    public static FurnaceFile convertMusicEntry(MusicEntry me, FurnaceFile ff){
        ...
        C2FYmInstrumentConverter.convertYmInstruments(me.getYmInstruments(), me.isSsgEgAvailable(), ff);
        C2FSampleConverter.convertSamples(me.getSampleEntries(), me.getSampleBanks(), me.isMultiSampleBank(), ff);
        C2FPsgInstrumentConverter.convertPsgInstruments(me.getPsgInstruments(), ff);
    ...
    public static Pattern[] convertPatterns(MusicEntry me, C2FPatternConverter[] converters, boolean introOnly, boolean mainLoopOnly){
        ...
        patterns[0] = converters[0].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[0], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        patterns[1] = converters[1].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[1], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        patterns[2] = converters[2].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[2], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        patterns[3] = converters[3].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[3], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        patterns[4] = converters[4].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[4], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        if(!me.isYm6InDacMode()){
            patterns[5] = converters[5].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[5], Pattern.TYPE_FM, introOnly, mainLoopOnly);
        }else{
            patterns[5] = converters[5].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[5], Pattern.TYPE_DAC, introOnly, mainLoopOnly);
        }
        patterns[6] = converters[6].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[6], Pattern.TYPE_PSGTONE, introOnly, mainLoopOnly);
        patterns[7] = converters[7].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[7], Pattern.TYPE_PSGTONE, introOnly, mainLoopOnly);
        /*patterns[8] = new Pattern();*/
        patterns[9] = new Pattern();
        patterns[8] = converters[8].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[8], Pattern.TYPE_PSGTONE, introOnly, mainLoopOnly);
        /*patterns[9] = converters[9].convertCubeChannelToFurnacePattern(me.getYmLevels(), me.getPitchEffects(), me.getChannels()[9], Pattern.TYPE_PSGNOISE, introOnly, mainLoopOnly);*/
        return patterns;
    }
