...
public class SongInfoBlock {
    ...
    private byte limitSlides = 1;
    private byte linearPitch = 1;
    ...
    private byte legacyVolumeSlides = 1;
    private byte compatibleArpeggio = 1;
    ...
    private byte brokenSpeedSelection = 1;
    private byte noSlidesOnFirstTick = 0;
    private byte nextRowResetArpPos = 0;
    private byte ignoreJumpAtEnd = 1;
    private byte buggyPortamentoAfterSlide = 1;
    ...
    private byte e1xyAnde2xyAlsoTakePriorityOverSlide00 = 1;
    private byte newSegaPcm = 1;
    private byte weirdFnumBlockBasedChipPitchSlides = 1;
    private byte snDutyMacroAlwaysResetsPhase = 1;
    ...
    private byte disableOpn2DacVolumeControl = 1;
    private byte newVolumeScalingStrategy = 0;
    private byte volumeMacroStillAppliesAfterEnd = 0;
    private byte brokenOutVol = 1;
    private byte e1xyAnde2xyStopOnSameNote = 1;
    private byte brokenInitialPositionOfPortaAfterArp = 0;
    private byte snPeriodsUnder8AreTreatedAs1 = 1;
    private byte cutDelayEffectPolicy = 0;
    private byte effect0b0dtreatment = 2;
    private byte automaticSystemNameDetection = 0;
    private byte disableSampleMacro = 1;
    private byte brokenOutVolEpisode2 = 1;
    ...
    private byte preNoteC64DoesNotCompensateForPortamentoOrLegato = 1;
    private byte disableNewNesDpcmFeatures = 1;
    private byte resetArpEffectPhaseOnNewNote = 0;
    private byte linearVolumeScalingRoundsUp = 0;
    private byte legacyAlwaysSetVolumeBehavior = 1;
    private byte legacySampleOffsetEffect = 0;
    private byte lengthOfSpeedPattern = 2;
